import {FormControl, RadioGroup, Stack,FormControlLabel,Radio, TextField, InputAdornment} from '@mui/material'
    ...
    >
             <FormControl>
                 ...
                 >
                      ...
                      <FormControlLabel value={1} control={<Radio/>}label="Normal Fee" />
                      {Boolean(costType) && (
